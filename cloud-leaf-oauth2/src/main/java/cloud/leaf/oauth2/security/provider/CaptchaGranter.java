...
public class CaptchaGranter extends AbstractTokenGranter {
    ...
    public CaptchaGranter(AuthenticationManager authenticationManager,
                          AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, StringRedisTemplate redisTemplate) {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        if (!StrUtil.equals(captcha, captchaCode)) {
