...
public class WebSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http, RegisteredClientRepository registeredClientRepository, OAuth2AuthorizationService authorizationService) throws Exception {
        ...
        authorizationServerConfigurer.tokenEndpoint(tokenEndpoint -> tokenEndpoint
                ...
                .authenticationProvider(new Oauth2CaptchaAuthenticationProvider(registeredClientRepository, authorizationService)));
